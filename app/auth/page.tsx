...
const Auth = () => {
  return (
    <main className="relative max-w-xl mx-auto px-10 min-h-screen flex flex-col gap-6 items-center justify-center overflow-hidden">
      ...
      <Link href="/" className="mt-6 w-full flex items-center justify-center gap-3 rounded-full bg-black px-6 py-4 text-base font-medium text-white transition-colors hover:bg-gray-900 active:bg-gray-800">
