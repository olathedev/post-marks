...
const desktopSlides = [
  {
    title: "Welcome!",
    description:
      "This is a PostMarks board — a space to leave messages, doodles, and good vibes for someone special.",
  },
  {
    title: "Navigate the Canvas",
    description:
      "Scroll or click and drag to pan around. Use the +/- controls to zoom in and out. Hover over a note to focus on it.",
  },
  {
    title: "Leave a Message",
    description:
      "Tap the + button in the bottom-right to write a sticky note or draw a doodle. Pick a color, add your name, and post it.",
  },
];
...
const mobileSlides = [
  ...
  },
  {
    ...
    description:
      "Scroll through all the messages and doodles people have left. Each sticky note is unique.",
  },
  {
    title: "Leave a Message",
    description:
      "Tap the + button at the bottom to write a sticky note or draw a doodle. Pick a color, add your name, and post it.",
  },
];

const STORAGE_KEY = "postmarks-visitor-tour-seen";

export function VisitorTour({ boardSlug }: { boardSlug: string }) {
  ...
  useEffect(() => {
    ...
    const key = `${STORAGE_KEY}-${boardSlug}`;
  ...
  const dismiss = () => {
    setOpen(false);
    localStorage.setItem(`${STORAGE_KEY}-${boardSlug}`, "true");
  };
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            initial={isMobile ? { y: 100, opacity: 0 } : { scale: 0.92, opacity: 0, y: 20 }}
          ...
          >
            ...
            <div className="relative h-24 overflow-hidden bg-white">
              ...
              <div className="absolute inset-0 z-10 flex items-center justify-center">
                ...
                >
                  <Image src="/logo.svg" alt="PostMarks" width={36} height={36} />
                </motion.div>
              </div>
            ...
            {/* Content */}
            <div className="relative overflow-hidden px-6 pb-5" style={{ minHeight: 160 }}>
              <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                  ...
                  <p className="mb-5 text-center text-sm leading-relaxed text-gray-400">
                    {slide.description}
                  </p>
                </motion.div>
              </AnimatePresence>
